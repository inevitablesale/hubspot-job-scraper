...
export const getState = () => client.get('/state').then((r) => r.data)
...
export const runFull = (payload = {}) => client.post('/run/full', payload).then((r) => r.data)
...
export const getVersion = () => client.get('/version').then((r) => r.data)
...
export const updateSettings = (payload) => client.post('/settings/update', payload).then((r) => r.data)
